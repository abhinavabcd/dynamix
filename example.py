import dynamix
from dynamix.model import Model
from dynamix.fields import CharField, IntegerField, SetField, ListField,\
    DictField
import time

dynamix.set_connection(is_local_endpoint=True)
...
class ForumThread(Model):
    ...
    __secondary_indexes__ = {
                             "user_threads_index": dict(hash_key="user_id", range_key="updated_at", read_capacity=2, write_capacity=2, projections=["title"]), #secondary index
                            }
